# Carambal.fr meets Hugo
Tentative de refonte du site carambal.fr via le générateur de site statique Hugo.
L'objectif est de se passer de Wordpress ou de CMS pour optimiser la vitesse
